...
export default function EditProjectForm({ project }: EditProjectFormProps) {
  ...
  // Form states initialized with existing database values
  ...
  const [displayOrder, setDisplayOrder] = useState(String(project.display_order || '1'))
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Modify the project details below.</p>
        </div>
      </div>
